    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          <h3>{`${this.state.name} 的座右铭是：`}</h3>
          <p>{this.state.motto}</p>
          <textarea name="motto" id="motto" cols="80" rows="4" value={this.state.motto} onChange={this.handleMottoChange}>{this.state.motto}</textarea>
        </div>
...
<input type="text" value={this.state.inputValue} onChange={this.handleChangeBound} />`}
  ...
  >
    Call handleButtonClick function with two
        ...
        <div className="cs142-example-output">
          <p>
            Test button clicks.{this.state.buttonWasClicked
              && <span>Last button clicked was: {this.state.buttonWasClicked}</span>}
          </p>
